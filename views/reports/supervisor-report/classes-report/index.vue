...
import {
  getSupervisorClassLearningpathsRequest,
  getSupervisorClassChartRequest,
  getSupervisorClassReportsRequest,
...
export default {
  ...
  methods: {
    ...
    getStudentReport(paramsWithSearch) {
      ...
      this.ApiService(getSupervisorClassReportsRequest(params)).then((response) => {
    ...
    getMissionsReportChart(paramsWithSearch) {
      const params = { ...paramsWithSearch, ...this.searchWithPagination };
      this.ApiService(getSupervisorClassLearningpathsRequest(params)).then((response) => {
        this.missionsInChart = response.data.data;
      });
    },
    getChartMissionsContentsCharts(paramsWithSearch) {
      const params = { ...paramsWithSearch, ...this.searchWithPagination };
      this.ApiService(getSupervisorClassChartRequest(params)).then((response) => {
