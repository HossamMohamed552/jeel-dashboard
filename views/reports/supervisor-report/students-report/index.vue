          ...
          <section slot="pdf-content" class="pdf-content">
            ...
            <div class="filter">
              <b-row>
                ...
                <b-col lg="3">
                  <span
                    >{{ studentReportListHeaders[2].label }} :
                ...
                <b-col lg="3">
                  <span
                    >{{ studentReportListHeaders[4].label }} :
                    {{ valuesOfAdvancedSearch.class_id }}</span
                  >
                </b-col>
                <b-col lg="3">
                  <span
                    >{{ studentReportListHeaders[0].label }} :
                    {{ valuesOfAdvancedSearch.user_id }}</span
                  >
                </b-col>
              </b-row>
            </div>
            ...
            >
              ...
              <b-row>
                <b-col
                  ><span>{{ student.student_name }}</span></b-col
                >
                <b-col
                ...
                >
                <b-col
                  ><span>{{ student.mission_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.lesson_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.user_mission_videos_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.mission_videos_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.user_mission_quiz_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.mission_quizzes_count }}</span></b-col
                >
                <b-col
                ...
                >
                <b-col
                  ><span>{{ student.mission_tasks_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.user_mission_single_paperworks_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.mission_single_paperworks_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.user_mission_participatory_paperworks_count }}</span></b-col
                >
                <b-col
                  ><span>{{ student.mission_participatory_paperworks_count }}</span></b-col
                >
              </b-row>
            </div>
...
import {
  getSupervisorStudentsLearningpathsRequest,
  getSupervisorStudentsChartRequest,
...
export default {
  ...
  methods: {
    ...
    getStudentReport(paramsWithSearch) {
      ...
      this.ApiService(getSupervisorStudentsPerformanceRequest(params)).then((response) => {
    ...
    getChartLearningPathsReportChart(paramsWithSearch) {
      const params = { ...paramsWithSearch, ...this.searchWithPagination };
      this.ApiService(getSupervisorStudentsLearningpathsRequest(params)).then((response) => {
        this.missionsInChart = response.data.data;
      });
    },
    getChartMissionsContentsCharts(paramsWithSearch) {
      const params = { ...paramsWithSearch, ...this.searchWithPagination };
      this.ApiService(getSupervisorStudentsChartRequest(params)).then((response) => {
