...
import {
  getTeacherStudentsLearningpathsRequest,
  getTeacherStudentsChartRequest,
...
export default {
  ...
  methods: {
    ...
    getChartLearningPathsReportChart(paramsWithSearch) {
      const params = { ...paramsWithSearch, ...this.searchWithPagination };
      this.ApiService(getTeacherStudentsLearningpathsRequest(params)).then((response) => {
        this.missionsInChart = response.data.data;
      });
    },
    getChartMissionsContentsCharts(paramsWithSearch) {
      const params = { ...paramsWithSearch, ...this.searchWithPagination };
      this.ApiService(getTeacherStudentsChartRequest(params)).then((response) => {
