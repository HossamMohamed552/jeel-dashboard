          ...
          <section slot="pdf-content" class="pdf-content">
            ...
            <div class="filter">
              <b-row>
                ...
                <b-col lg="3">
                  <span>{{studentReportListHeaders[0].label }}: {{ valuesOfAdvancedSearch.study_year_id }}</span>
                </b-col>
                <b-col lg="3">
                  <span>{{studentReportListHeaders[1].label}} : {{ valuesOfAdvancedSearch.level_id }}</span>
                </b-col>
              </b-row>
            </div>
            <div class="header">
            ...
            <div v-for="(student,index) in studentReportList" :key="student.id"
              ...
              <b-row>>
                <b-col><span v-for="level in student.levels">{{ level.name }}</span></b-col>
              </b-row>
            </div>
...
import {
  ...
  getSchoolAdminMissionsRequest, getSchoolAdminStudentsRequest
