...
import {
  ...
  getQuestionTypsRequest, getSingleQuestionRequest,
} from "@/api/question";
...
export default {
  ...
  methods: {
    ...
    saveQuestion() {
      ...
      if (this.collectData.question !== null && (this.collectData.question_pattern === 'image' || this.collectData.question_pattern === 'audio') && this.collectData.questionChangedRequest) {
      ...
      axios
        .post(`/questions/${this.$route.params.id}`, formData, {
          headers: {
