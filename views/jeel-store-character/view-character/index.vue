      ...
      <div class="hold-fields">
        ...
        <b-row>
          ...
          <b-col md="4" sm="12">
            <ShowItem
              ...
              :subtitle="characters.type[0].key"
            />
          </b-col>
        </b-row>
        <b-row>
          <b-col md="4" sm="12">
            <ShowItem
              class="divider-show"
              :title="$t('TABLE_FIELDS.term')"
              :subtitle="characters.level.name"
            />
          </b-col>
          <b-col md="4" sm="12">
            <ShowItem
              class="divider-show"
              :title="$t('TABLE_FIELDS.gems_num')"
              :subtitle="characters.gems"
            />
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col lg="12" class="mb-5 mt-4">
            <PreviewMedia
              :header="$t('jeelStoreCharacter.character_logo')"
