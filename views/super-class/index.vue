<template>
  <section class="container-fluid custom-container">
    <ListItems :header-name="$t('schoolAdmin.classesMainList')" :number-of-item="totalNumber"
               :tableItems="classesList" :fields-list="fieldsList" :v-search-model="groupSearchWord"
