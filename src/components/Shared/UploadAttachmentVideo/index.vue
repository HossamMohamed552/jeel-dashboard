    ...
    >
      <div class="dropzone-custom-content">
        ...
        <div class="subtitle">
          ...
          <div class="subtitle">
            <p>{{ $t('CONTROLS.file_size') }} {{ dropzoneOptionsVideo.maxFilesize }}
...
export default {
  ...
  created() {
    this.dropzoneOptionsVideo.url = `${process.env.VUE_APP_ADMIN_URL}/attachment`;
    if (this.typeOfAttachment === "video") {
      this.dropzoneOptionsVideo.maxFilesize = 1024;
    }
  },
};
</script>
