    ...
    >
      <div class="dropzone-custom-content">
        ...
        <div class="subtitle">
          ...
          <div class="subtitle">
            <p>{{ $t('CONTROLS.file_size') }} {{ dropzoneOptionsAudio.maxFilesize }}
...
export default {
  ...
  data() {
    return {
      dropzoneOptionsAudio: {
        acceptedFiles: "audio/mpeg,audio/mpga,audio/mp3,audio/wav",
        url: "",
        timeout: null,
        // chunking: true,
        // chunkSize: 50,
  ...
  created() {
    ...
    this.dropzoneOptionsAudio.url = `${process.env.VUE_APP_ADMIN_URL}/attachment`;
    if (this.typeOfAttachment === "video") {
      this.dropzoneOptionsAudio.maxFilesize = 1024;
    }
  },
};
</script>
