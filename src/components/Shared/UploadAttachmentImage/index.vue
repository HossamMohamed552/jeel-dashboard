    ...
    >
      <div class="dropzone-custom-content">
        ...
        <div class="subtitle">
          ...
          <div class="subtitle">
            <p>{{ $t('CONTROLS.file_size') }} {{ dropzoneOptionsImage.maxFilesize }}
...
export default {
  ...
  created() {
    ...
    this.dropzoneOptionsImage.url = `${process.env.VUE_APP_ADMIN_URL}/attachment`;
    if (this.typeOfAttachment === "video") {
      this.dropzoneOptionsImage.maxFilesize = 1024;
    }
  },
};
</script>
