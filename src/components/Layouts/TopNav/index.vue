      ...
      <div class="row collapsed" v-if="collapseMode">
        <div class="col-12">
            ...
            <b-collapse id="nav-collapse" is-nav>
              <b-navbar-nav>
                ...
                <b-nav-item class="nav-item" v-if="user.is_super_admin === 1">
                  <router-link tag="p" to="/dashboard/home" style="color: #fff">{{
                    $t("MENU.infoDashBoard")
                  }}</router-link>
                </b-nav-item>

                <b-nav-item class="nav-item" v-if="user.is_super_admin === 1">
                  <router-link style="color: #fff" tag="p" to="/dashboard/home">{{
                    $t("MENU.reports")
                  }}</router-link>
                </b-nav-item>
              </b-navbar-nav>
          ...
          >
            ...
            <b-nav-item
              class="nav-item"
              v-if="Array.from(routeSuperVisor).length >= 1"
      ...
      <div class="row" v-else>
        <div class="col-12">
          ...
          >
            ...
            <div class="nav-item" v-if="Array.from(routesMissions).length >= 1 && user.roles[0]?.type.key === 'system_administration'">
              <p>
